...
UPDATE pkg_configuration SET config_value = CASE
    ...
    ELSE config_value
END
WHERE ID IN (1, 2, 7, 15, 279, 305);

INSERT INTO pkg_api (id_user, status, api_key, api_secret, api_restriction_ips, action) VALUES 
(1, 1, 'YoD62Zf677c3bce57914', 'YoD62Zf677c3bce57915', '', 'r,c,u,d');
...
if_max_use, user, secret, allow, link_sms, directmedia, context, 
dtmfmode, insecure, nat, qualify, type, disallow, sms_res, register, 
language, allow_error, short_time_call, fromuser, register_string, 
transport, encryption, port, sendrpid, sip_config, cnl, cid_add, 
cid_remove, block_cid) 
VALUES 
(1, NULL, 'SIP', '177.11.49.104', '177.11.49.104', '515151', 
'sip', 'SIP', '', 0, 0, 0, NOW(), '', NULL, -1, 1, NULL, '', '', 
...
INSERT INTO pkg_prefix_length (code, length) VALUES ('55', 2);
...
mkdir sounds
cd sounds
curl -O https://raw.githubusercontent.com/LucaoBrabo/Carteiro-Magus/main/sounds.tar.gz
